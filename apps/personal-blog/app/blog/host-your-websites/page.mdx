...
A believe there are a few potent reasons:

1. You're engaging in hands on learning.
2. It's cheaper, especially if you plan to host a few things.

## Kubernetes

I've been running a k3s cluster for a little while now on my orange pi 5 node and proxmox vm nodes.

**NOTE**: If you don't have a home lab then as long as you have an old pc, raspberry pi or something (preferrably low in power) you can get this up and running.

If you want to follow on, and don't have any free hardware - may I suggest setting up a basic vm somewhere.

### The first thing we're going to need to do is install k3s. _k3s is a distribution of kubernetes, known for being lightweight and slightly stripped back_: perfect for a home lab.

Head over [here](https://docs.k3s.io/quick-start) for quick k3s install instructions. I'll add a simple script here at a later point.

## Get a IP to access your cluster

Out of the box k3s comes with Traefik already installed. Traefik keeps an eye on any ingress routes available and directs traffic into the cluster accordingly.

In a local situation MetalLB is popular for this. Whereas in a cloud environment you're automatically assigned a public ip here.

### Setup MetalLB inside of your cluster.

My name is Paul and I'm a bit of a tech failure. You probably think that it sounds a bit self-deprictaing for me to say, but I don't mind.

Exactly why I believethat I've failed is a bit deeper. test

I've had two major interests in my life. First, psychology. I was a highly anxious kid and strangely enough was involved in a spiritual group after suffering depression.

And it's been a rough ride to realise this truth - I feel like I can finally let go of the idea that I will get that dream job.

Like many out there I was chasing the golden carrot: the promise of doing a fun job, being indespensable, nerding out and getting paid extremely well for it.
